###########################################################################
## Makefile generated for component 'Tem_control_identification'. 
## 
## Makefile     : Tem_control_identification.mk
## Generated on : Mon Sep 08 22:44:29 2025
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/Tem_control_identification.elf
...
PRODUCT_NAME              = Tem_control_identification
MAKEFILE                  = Tem_control_identification.mk
MATLAB_ROOT               = C:/PROGRA~1/MATLAB/R2025a
MATLAB_BIN                = C:/PROGRA~1/MATLAB/R2025a/bin
MATLAB_ARCH_BIN           = $(MATLAB_BIN)/win64
START_DIR                 = C:/Proyecto/Modulo_2/CONTROL_TEMPERATURA/Archivos_Simulink/DHT11_TEMPERATURE_CONTROL/DHT11
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
TGT_FCN_LIB               = None
...
SLIB_PATH                 = C:/Users/jctib/DOCUME~1/MATLAB/R2025a/ARDUIN~1/ESP32W~1/FASTER~1
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/Tem_control_identification.elf
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(START_DIR)/Dependencies -I$(MATLAB_ROOT)/toolbox/target/shared/svd/common/include -IC:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinobase/include -I$(START_DIR)/Tem_control_identification_ert_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common -I$(MATLAB_ROOT)/rtw/c/ert -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/common -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/protocol/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/transport/src -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/server/platform/default -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/include -I$(MATLAB_ROOT)/toolbox/coder/xcp/src/target/ext_mode/src -I$(MATLAB_ROOT)/toolbox/coder/rtiostream/src -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/cores/esp32 -I$(ARDUINO_ESP32_ROOT)/hardware/esp32/$(ESP32_LIB_VERSION)/variants/esp32 -I$(ARDUINO_ESP32_ROOT)/tools/esptool_py -I$(ARDUINO_ESP32_ROOT)/tools/mkspiffs -IC:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/include -IC:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/supportpackages/arduinotarget/scheduler/include -IC:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/shared/freertos/include -I$(START_DIR)/include -IC:/ProgramData/MATLAB/SupportPackages/R2025a/aCLI/data/packages/esp32/hardware/esp32/2.0.11/libraries/Wire/src -IC:/ProgramData/MATLAB/SupportPackages/R2025a/aCLI/data/packages/esp32/hardware/esp32/2.0.11/libraries/SPI/src -IC:/ProgramData/MATLAB/SupportPackages/R2025a/aCLI/user/libraries/ServoESP32/src
...
DEFINES_CUSTOM = 
DEFINES_OPTS = -DXCP_DAQ_SUPPORT -DXCP_CALIBRATION_SUPPORT -DXCP_TIMESTAMP_SUPPORT -DXCP_TIMESTAMP_BASED_ON_SIMULATION_TIME -DXCP_SET_MTA_SUPPORT -DEXTMODE_XCP_TRIGGER_SUPPORT -DXCP_MEM_BLOCK_1_SIZE=32 -DXCP_MEM_BLOCK_1_NUMBER=1 -DXCP_MEM_BLOCK_2_SIZE=56 -DXCP_MEM_BLOCK_2_NUMBER=1 -DXCP_MEM_BLOCK_3_SIZE=24 -DXCP_MEM_BLOCK_3_NUMBER=1 -DXCP_MEM_RESERVED_POOLS_TOTAL_SIZE=325 -DXCP_MEM_RESERVED_POOLS_NUMBER=2 -DXCP_MEM_DAQ_RESERVED_POOL_BLOCKS_NUMBER=3 -DXCP_MEM_DAQ_RESERVED_POOLS_NUMBER=1 -DXCP_MIN_EVENT_NO_RESERVED_POOL=1 -DXCP_MAX_CTO_SIZE=32 -DXCP_MAX_DTO_SIZE=65532 -DXCP_MAX_ODT_ENTRY_SIZE=255 -DEXTMODE_STATIC -DEXTMODE_STATIC_SIZE=65536 -DON_TARGET_WAIT_FOR_START=1 -DTID01EQ=0
...
DEFINES_STANDARD = -DMODEL=Tem_control_identification -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DMODEL_HAS_DYNAMICALLY_LOADED_SFCNS=0
...
OBJS = DHT11.o Adafruit_Sensor.o DHT.o DHT_U.o MW_PWM.o MW_PWMDriver.o ArduinoPinHandleMap.o xcp_ext_mode.o Tem_control_identification.o Tem_control_identification_data.o xcp_ext_common.o xcp_ext_classic_trigger.o xcp.o xcp_standard.o xcp_daq.o xcp_calibration.o xcp_fifo.o xcp_transport.o xcp_mem_default.o xcp_drv_rtiostream.o xcp_utils.o xcp_frame_serial.o xcp_ext_param_default_serial.o MW_ArduinoHWInit.o io_wrappers.o IPAddress.o Print.o mw_freertos_init.o mw_thread.o mw_timer.o mw_semaphore.o platform_timer.o rtiostream_serial_daemon.o
...
%.o : $(START_DIR)/Tem_control_identification_ert_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.S.o : $(START_DIR)/Tem_control_identification_ert_rtw/%.s
	$(AS) $(ASFLAGS) -o "$@" "$<"
...
%.o : $(START_DIR)/Tem_control_identification_ert_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
DHT11.o : $(START_DIR)/DHT11.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


Adafruit_Sensor.o : $(START_DIR)/Dependencies/Adafruit_Sensor.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


DHT.o : $(START_DIR)/Dependencies/DHT.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"


DHT_U.o : $(START_DIR)/Dependencies/DHT_U.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
...
ert_main.o : $(START_DIR)/Tem_control_identification_ert_rtw/ert_main.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Tem_control_identification.o : $(START_DIR)/Tem_control_identification_ert_rtw/Tem_control_identification.c
	$(CC) $(CFLAGS) -o "$@" "$<"


Tem_control_identification_data.o : $(START_DIR)/Tem_control_identification_ert_rtw/Tem_control_identification_data.c
	$(CC) $(CFLAGS) -o "$@" "$<"
...
mw_freertos_init.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/shared/freertos/src/mw_freertos_init.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_thread.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/shared/freertos/src/mw_thread.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_timer.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/shared/freertos/src/mw_timer.c
	$(CC) $(CFLAGS) -o "$@" "$<"


mw_semaphore.o : C:/ProgramData/MATLAB/SupportPackages/R2025a/toolbox/target/shared/freertos/src/mw_semaphore.c
	$(CC) $(CFLAGS) -o "$@" "$<"
